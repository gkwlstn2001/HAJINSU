...
<body>
	...
	<div class="contact-form-area mb-70" id="alldiv">
		<br/>
		<h4 class="mb-50" id="TITLENAME">고객의 소리(VOC) 수정페이지</h4>

		<form action="vocupdateok" method="post" enctype="multipart/form-data">
				...
				<div class="col-lg-6"  id="EMAILBOX">
				<div class="form-group">
						<input type="text" class="form-control" id="EMAIL" name="VOCID" placeholder="VOCID" value="${vocdto.VOCID}" readonly>
				</div>
				</div>
			<div class="row">
				<div class="col-lg-6" id="TITLEBOX">
					<div class="form-group" >
						<textarea class="form-control" id="TITLE" name="TITLE" cols="1" rows="1" placeholder="제목">${vocdto.TITLE}</textarea>
					</div>
				</div>
				<div class="col-12" id="CONTENTBOX">
					<div class="form-group">
						<textarea class="form-control" id="CONTENT" name="CONTENT" cols="30" rows="10" placeholder="내용">${vocdto.CONTENT}</textarea>
					</div>
				</div>
