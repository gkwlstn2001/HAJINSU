        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-slide" id="imagebox">
                ...
                <div class="blog-thumbnail">
                    <a href="boardcontent?bbsid=${nbbs.BBSID}"><img id="picturebox" src="${nbbs.SAVEFILENAME}" alt=""></a>
                </div>
            </div>
            </c:forEach>
        </div>
    ...
    <div class="big-posts-area mb-50">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <a href="boardcontent?bbsid=${maxcontent.BBSID}"><img id="maxpicture" src="${maxfile.SAVEFILENAME}" alt=""></a>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="big-post-content text-center mb-50">
                        ...
                        <%-- <li class="a">
                        <a href="#" class="post-tag">${maxcontent.REGION2}</a>
                        </li> --%>
                        </ul>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <a href="boardcontent?bbsid=${recentcontent.BBSID}"><img id="recentpicture" src="${recentfile.SAVEFILENAME}" alt=""></a>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="big-post-content text-center mb-50">
                        ...
                        <%-- <li class="a">
                        <a href="#" class="post-tag">${recentcontent.REGION2}</a>
                        </li> --%>
                        </ul>
