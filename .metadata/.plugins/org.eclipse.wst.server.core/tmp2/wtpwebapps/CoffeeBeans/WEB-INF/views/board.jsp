...
<body>
	...
	<div class="catagory-post-area section-padding-100">
		<div class="container">
			...
			<div class="col-12" id="pagenumbering">
				...
				<ul class="b">
					<li class="a">
						<select name="searchcategory">
							<option value="TITLE" name="TITLE">글제목</option>
							<option value="CONTENT" name="CONTENT">글내용</option>
							<option value="EMAIL" name="EMAIL">글쓴이</option>
						</select>
					</li>
					<li class="a">
						<input type="text" name="SEARCHKEY" value="" placeholder="검색창">
					</li>
					<li class="a">
						<button>검색 버튼</button>
					</li>
