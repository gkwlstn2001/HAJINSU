...
<body>
	...
	function getCommentList() {
			...
			success : function(data) {
	            ...
	            if(data.length > 0){
	                ...
	                for(i=0; i<data.length; i++)	{
	                    ...
	                    html += '<c:if test="${SessionEMAIL=='data[i].EMAIL'}">';
	                    html += '<a href="#updateanchor" class="post-date" onclick="makeupdateframe()">수정</a>';
	                    html += '<a href="#updateanchor" class="post-date" onclick="makedeleteform()">삭제</a>';
	                    html += '</c:if>';
		...
		console.log($('a#commentemail').text);
	...
	function makeupdateframe() {
		...
		html +='</div>';
		html +='<div class="col-6">';
		html +='<input type="text" class="form-control" id="COMMENTSID" name="COMMENTSID" value="" placeholder="수정할 댓글번호" required>';
		html +='</div>';
	...
	function makedeleteform() {
		...
		html +='</div>';
		html +='<div class="col-6">';
		html +='<input type="text" class="form-control" id="COMMENTSID" name="COMMENTSID" value="" placeholder="삭제할 댓글번호" required>';
		html +='</div>';
		html +='<div id="centerbutton">';
		html +='<ul><li class="a">';
		html +='<div class="col-6">';
