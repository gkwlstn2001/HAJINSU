	...
	<div class="wrapper">
		...
		<form action="writeok" method="post" enctype="multipart/form-data">
			...
			<div class="writeboard">
				...
				<div class="Content">
					<textarea class="Content1" rows="20" cols="80" name="CONTENT">[기본 글양식]
주차시설 : 
맛 : 
분위기 : 
서비스 : 
...
[내용]
			...
			<p class="mapinfo"><em>지도를 클릭해주세요!</em></p>
			<div class="mapinfo" id="clickLatlng" name="mapinformation"></div>
			<input type="text" value="" name="LATITUDE" id="mapinput" class="f" required>
			<input type="text" value="" name="LONGITUDE" id="mapinput2" class="f" required>
			...
			<script>
				...
				var iwContent = '<div style="padding:5px;"><a href="https://map.kakao.com/link/map/Hello World!,36.351213, 127.454311" style="color:blue" target="_blank">큰지도보기/</a> <a href="https://map.kakao.com/link/to/Hello World!,36.351213, 127.454311" style="color:blue" target="_blank">길찾기</a></div>', 
				// 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
				iwPosition = new kakao.maps.LatLng(36.351213, 127.454311); //인포윈도우 표시 위치입니다
					...
					<li class="b">
						<p>
							<label for="image">카페 후기이미지1</label> <br /> <input
								multiple="multiple" type="file" name="BBS_FILE1" id="image" required/>
						</p>
					...
					<li class="b">
						<p>
							<label for="image">카페 후기이미지2</label> <br /> <input
								multiple="multiple" type="file" name="BBS_FILE2" id="image2" required/>
						</p>
					...
					<li class="b">
						<p>
							<label for="image">카페 후기이미지3</label> <br /> <input
								multiple="multiple" type="file" name="BBS_FILE3" id="image3" required/>
						</p>
					...
					<li class="b">
						<p>
							<label for="image">카페 후기이미지4</label> <br /> <input
								multiple="multiple" type="file" name="BBS_FILE4" id="image4" required/>
						</p>
