...
<body>
											...
											<div class="blog-thumbnail">
												<a href="#">
													<div class="single-instagram" id="divbox">
														<img id="picturebox" src="${bbsfiledtolist.SAVEFILENAME}">
														<!-- Image Zoom -->
														<a href="${bbsfiledtolist.SAVEFILENAME}" class="img-zoom"
										...
										<div class="row">
											<div class="col-12 col-lg-6">
												<input type="text" class="form-control" id="EMAIL"
													name="EMAIL" placeholder="EMAIL" value="${SessionEMAIL}">
											</div>
											<div class="col-12 col-lg-6">
											...
											<div class="col-12">
												<%-- <button id="commentsbutton" class="btn bueno-btn mt-30"
													type="submit" onclick="commentwrite('${bbsdto.BBSID}')">댓글 작성</button> --%>
			...
			success : function(data) {
	            ...
	            if(data.length > 0){
	                ...
	                for(i=0; i<data.length; i++)	{
	                    ...
	                    html += '<a href="#" class="post-author">' + data[i].EMAIL + '</a>';
	                    html += '<a href="#" class="post-date">' + data[i].COMMENTSDATE + '</a>';
	                    html += '<a href="#updateanchor" class="post-date" onclick="makeupdateframe()">수정</a>';
	                    html += '<a href="#" class="post-date">삭제</a>';
	...
	function makeupdateframe() {
		var html = "";
		
		html +='<form id="ajaxform" action="#" method="post">';
		html +='<div class="row">';
		html +='<div class="col-6">';
		html +='<input type="text" class="form-control" id="BBSID" name="BBSID" value="게시글 번호 : ${bbsdto.BBSID}" readonly>';
		html +='</div>';
		html +='<div class="col-6">';
		html +='<input type="text" class="form-control" id="COMMENTSID" name="COMMENTSID" value="댓글번호 : " readonly>';
		html +='</div>';
		html +='<div class="col-12">';
		html +='<input type="text" class="form-control" id="EMAIL" name="EMAIL" placeholder="EMAIL" value="${SessionEMAIL}">';
		html +='</div>';
		html +='<div class="col-12">';
