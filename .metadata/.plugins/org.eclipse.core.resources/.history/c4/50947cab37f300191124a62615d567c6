	...
	<div class="wrapper">
		...
		<form action="updateok" method="post" enctype="multipart/form-data">
			...
			<div class="writeboard">
				...
				<div class="d">
					<textarea class="e" rows="1" cols="80" name="WRITEDATE" readonly>${bbsdto.WRITEDATE}</textarea>
				</div>
				<div class="d">
					<textarea class="e" rows="1" cols="80" name="VIEWSCOUNT" readonly>${bbsdto.VIEWSCOUNT}</textarea>
				</div>
				...
				<div class="Title">
					<textarea class="Title1" rows="2" cols="80" name="TITLE">${bbsdto.TITLE}</textarea>
				</div>
				...
				<ul>
					<c:forEach items="${bbsfiledto}" var="bbsfiledtolist" varStatus="i"
						...
						<li class="b">
							...
							<input multiple="multiple" type="file" name="BBS_FILE${i.count}"
							id="image${i.count}" required>
							</p>
							<div id="image_preview${i.count}">
								<img id="uploadimgsize" src="<spring:url value='/image/${bbsfiledtolist.SAVEFILENAME}'/>" width="400px" height="400px" /> <br /> 
								<a href="#">Remove</a>
							</div>
						</li>
					</c:forEach>
